...
//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomDeleteCustomerOrders
//
//   Description:    
//
//
...
[Export("CustomDeleteCustomerOrders", typeof(HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("[01] Delete all customer orders")]
[EnabledScript(true)]
public class CustomDeleteCustomerOrders : GenericTaskBase, HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask
{
    [Import]
    ...
    private string _TaskName = "CustomDeleteCustomerOrders";
    ...
    public override void Execute(IJobExecutionContext executionContext)
    {
        ...
        try
        {
            _Logger = LogHelper.GetLogger(executionContext.Area, typeof(CustomDeleteCustomerOrders));
        ...
        catch (Exception e)
        {
            ...
            _Logger.Error(ResourcesKeys.ErrorInUserExit("CustomDeleteCustomerOrders"), null, e);
            throw;
        }
    }
