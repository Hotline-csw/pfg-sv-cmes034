...
//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomDeleteFeedbacks
//
//   Description:    
//
//
...
[Export("CustomDeleteFeedbacks", typeof(HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("[01] Delete all feedbacks")]
[EnabledScript(true)]
public class CustomDeleteFeedbacks : GenericTaskBase, HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask
{
    [Import]
    ...
    private string _TaskName = "CustomDeleteFeedbacks";
    ...
    public override void Execute(IJobExecutionContext executionContext)
    {
        ...
        try
        {
            _Logger = LogHelper.GetLogger(executionContext.Area, typeof(CustomDeleteFeedbacks));
        ...
        catch (Exception e)
        {
            ...
            _Logger.Error(ResourcesKeys.ErrorInUserExit("CustomDeleteFeedbacks"), null, e);
            throw;
        }
    }
