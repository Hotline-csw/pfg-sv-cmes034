...
//-----------------------------------------------------------------------------
//   (Class-)Name:   DeleteWccStagingPostProduction
//
//   Description:    
//
//
...
[Export("DeleteWccStagingPostProduction", typeof(HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("[01] Delete all post-production parts in base.WccStagingRecords")]
[EnabledScript(true)]
public class DeleteWccStagingPostProduction : GenericTaskBase, HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask
{
    [Import]
    ...
    private string _TaskName = "DeleteWccStagingPostProduction";
    ...
    public override void Execute(IJobExecutionContext executionContext)
    {
        ...
        try
        {
            _Logger = LogHelper.GetLogger(executionContext.Area, typeof(DeleteWccStagingPostProduction));
            ...
            using(IUnitOfWork unitOfWork = _UnitOfWorkFactory.CreateUnitOfWork())
            {
                ...
                {
                    unitOfWork.BulkDelete(wccStagingRecord);
        ...
        catch (Exception e)
        {
            ...
            _Logger.Error(ResourcesKeys.ErrorInUserExit("DeleteWccStagingPostProduction"), null, e);
            throw;
        }
    }
