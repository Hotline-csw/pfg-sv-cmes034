...
//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomUpdateTransferStateKitchensWithBulksAndFeedback
//
//   Description:    
//
//
...
[Export("CustomUpdateTransferStateKitchensWithBulksAndFeedback", typeof(HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("[02] Update TransferState for kitchens with bulk planning and feedbacks")]
[EnabledScript(true)]
public class CustomUpdateTransferStateKitchensWithBulksAndFeedback : GenericTaskBase, HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask
{
    [Import]
    ...
    private string _TaskName = "CustomUpdateTransferStateKitchensWithBulksAndFeedback";
    ...
    public override void Execute(IJobExecutionContext executionContext)
    {
        ...
        try
        {
            _Logger = LogHelper.GetLogger(executionContext.Area, typeof(CustomUpdateTransferStateKitchensWithBulksAndFeedback));
        ...
        catch (Exception e)
        {
            ...
            _Logger.Error(ResourcesKeys.ErrorInUserExit("CustomUpdateTransferStateKitchensWithBulksAndFeedback"), null, e);
            throw;
        }
    }
