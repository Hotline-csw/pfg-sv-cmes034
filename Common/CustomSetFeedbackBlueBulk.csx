...
//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomSetFeedbackBlueBulk
//
//   Description:    
//
//
...
[Export("CustomSetFeedbackBlueBulk", typeof(HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("07_Set feedback for Bulk-Blue")]
[EnabledScript(true)]
public class CustomSetFeedbackBlueBulk : GenericTaskBase, HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask
{
    [Import]
    ...
    public override void Execute(IJobExecutionContext executionContext)
    {
        ...
        try
        {
            _Logger = LogHelper.GetLogger(executionContext.Area, typeof(CustomSetFeedbackBlueBulk));
...
//-----------------------------------------------------------------------------
        ...
        catch (Exception e)
        {
            ...
            _Logger.Error(ResourcesKeys.ErrorInUserExit("CustomSetFeedbackBlueBulk"), null, e);
            throw;
        }
    }
