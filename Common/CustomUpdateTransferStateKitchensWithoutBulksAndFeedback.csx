...
//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomUpdateTransferStateKitchensWithoutBulksAndFeedback
//
//   Description:    
//
//
...
[Export("CustomUpdateTransferStateKitchensWithoutBulksAndFeedback", typeof(HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("09_Update TransferState for kitchens without bulk planning and feedbacks")]
[EnabledScript(true)]
public class CustomUpdateTransferStateKitchensWithoutBulksAndFeedback : GenericTaskBase, HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask
{
    [Import]
    ...
    private string _TaskName = "CustomUpdateTransferStateKitchensWithoutBulksAndFeedback";
    ...
    public override void Execute(IJobExecutionContext executionContext)
    {
        ...
        try
        {
            _Logger = LogHelper.GetLogger(executionContext.Area, typeof(CustomUpdateTransferStateKitchensWithoutBulksAndFeedback));
        ...
        catch (Exception e)
        {
            ...
            _Logger.Error(ResourcesKeys.ErrorInUserExit("CustomUpdateTransferStateKitchensWithoutBulksAndFeedback"), null, e);
            throw;
        }
    }
