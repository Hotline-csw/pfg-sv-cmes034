...
//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomSetManualBulks
//
//   Description:    
//
//
...
[Export("CustomSetManualBulks", typeof(HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("05_Set manual bulks")]
[EnabledScript(true)]
public class CustomSetManualBulks : GenericTaskBase, HomagGroup.FLS.Services.Common.Contracts.JobScheduling.Configuration.Tasks.Generic.IGenericTask, IPartImportsSatisfiedNotification
{
    [Import]
    ...
    private string _TaskName = "CustomSetManualBulks";
    ...
    public override void Execute(IJobExecutionContext executionContext)
    {
        ...
        try
        {
            _Logger = LogHelper.GetLogger(executionContext.Area, typeof(CustomSetManualBulks));
        ...
        catch (Exception e)
        {
            ...
            _Logger.Error(ResourcesKeys.ErrorInUserExit("CustomSetManualBulks"), null, e);
            throw;
        }
    }
