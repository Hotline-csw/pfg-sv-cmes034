...
# 13 OptimizationMethod : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 14.1 ProductionOrders : DetailListView
|CanMultiselect|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|DisplayName|DisplayOrder|Filter|IsSecondary|IsSortable|Name|RowStyle|
|--|--|--|--|--|--|--|--|--|--|--|--|
|false|false|false|false|false|Fertigungsaufträge|1||false|true|ProductionOrders||
## 14.2 ProductionOrderSalesArticle : DetailRelationListView
|CanMultiselect|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|DetailProperties|DisplayName|DisplayOrder|Entity|Filter|IsSecondary|IsSortable|Name|ParentProperties|RowStyle|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
# 15 ProductionOrder : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 15.1 ResetBracketToStaging : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
...
## 15.8 EdgeProfilesImport : DetailRelationListView
|CanMultiselect|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|DetailProperties|DisplayName|DisplayOrder|Entity|Filter|IsSecondary|IsSortable|Name|ParentProperties|RowStyle|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 15.18 FehlerBeimAuftrag : CellStyleCondition
...
## 15.19 AuftragGesperrt : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CD5C5C|ReleaseState|2|#FFFFFF|AuftragGesperrt|ReleaseState="NotReleased"|
## 15.20 StatusBeendet : RowStyleCondition
|Background|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|
|#A8FAC5|1|#199619|StatusBeendet|ProductionState="Finished"|
## 15.21 StatusInBearbeitung : RowStyleCondition
|Background|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|
|#EEE8AA|2|#199619|StatusInBearbeitung|ProductionState="Processing"|
# 16 ProductionOrderAllData : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
|--|--|--|--|--|
|#A8FAC5|1|#199619|StatusBeendet|ProductionState="Finished"|
### 16.3.2 DisposeStateAlternative : RowStyleCondition
|Background|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|
...
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
|false|false|false|false|false|ProductionOrderCode|Kanten (Importdaten)|6|EdgeProfile|ProductionStep=null|false|true|EdgeProfilesImport|Code||
### 16.8.1 ProductionStepNull : RowStyleCondition
|Background|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|
...
### 16.9.1 DisposeStateAlternative : RowStyleCondition
|Background|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|
|#E7CEEC|1|#000000|DisposeStateAlternative|ProductionStep != null  &&  ProductionStep.DisposeState="Alternative"|
### 16.9.2 ProductionStepNull : RowStyleCondition
|Background|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|
|#CCD0D8|2|#000000|ProductionStepNull|ProductionStep=null|
...
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
|false|false|false|false|false|ProductionOrderCode|Nuten (Importdaten)|8|EdgeGroove|ProductionStep=null|false|true|EdgeGroovesImport|Code||
### 16.10.1 ProductionStepNull : RowStyleCondition
|Background|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|
|#CCD0D8|1|#000000|ProductionStepNull|ProductionStep=null|
...
### 16.12.1 DisposeStateAlternative : RowStyleCondition
|Background|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|
|#E7CEEC|1|#000000|DisposeStateAlternative|ProductionStep != null  &&  ProductionStep.DisposeState="Alternative"|
### 16.12.2 ProductionStepNull : RowStyleCondition
|Background|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|
|#CCD0D8|2|#000000|ProductionStepNull|ProductionStep=null|
...
|--|--|--|--|--|
|#E7CEEC|1|#000000|DisposeStateAlternative|ProductionStep != null  &&  ProductionStep.DisposeState="Alternative"|
## 16.17 ViewExtensionData : DetailRelationListView
|CanMultiselect|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|DetailProperties|DisplayName|DisplayOrder|Entity|Filter|IsSecondary|IsSortable|Name|ParentProperties|RowStyle|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 17.1 NavigateFromEdgePassesToProductionOrder : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
|F6||Zum FA navigieren|Öffne Maske ProductionOrder mit Filter ProductionOrderCode.|NavigateFromEdgePassesToProductionOrder|
### 17.1.1 NavigateFromEdgePassesToProductionOrder : CommandUserExit
|Name|Order|
|--|--|
|NavigateFromEdgePassesToProductionOrder|10|
## 17.2 EdgePassesFilterByGroup : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
|F3||Gruppe filtern (Arbeitsgang)|Filtert nach Gruppe/Arbeitsgang des selektierten Datensatzes|EdgePassesFilterByGroup|
### 17.2.1 EdgePassesFilterByGroup : CommandUserExit
|Name|Order|
|--|--|
|EdgePassesFilterByGroup|1|
#### 17.2.1.1 ShowAll : UserExitParameter
|Format|Name|PassNullValue|Value|
|--|--|--|--|
||ShowAll|false|False|
## 17.3 EdgePassFilterAll : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
|F4||Gruppenfilter aufheben|Zeigt wieder alle Datensätze|EdgePassFilterAll|
### 17.3.1 EdgePassesFilterByGroup : CommandUserExit
|Name|Order|
|--|--|
|EdgePassesFilterByGroup|1|
#### 17.3.1.1 ShowAll : UserExitParameter
|Format|Name|PassNullValue|Value|
|--|--|--|--|
||ShowAll|false|True|
## 17.4 EdgePassesFilterNextPass : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
...
### 17.4.1 EdgePassesFilterNextOrPreviousPass : CommandUserExit
|Name|Order|
|--|--|
|EdgePassesFilterNextOrPreviousPass|1|
#### 17.4.1.1 PreviousPass : UserExitParameter
|Format|Name|PassNullValue|Value|
|--|--|--|--|
||PreviousPass|false|False|
## 17.5 EdgePassesFilterPreviousPass : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
...
### 17.5.1 EdgePassesFilterNextOrPreviousPass : CommandUserExit
|Name|Order|
|--|--|
|EdgePassesFilterNextOrPreviousPass|1|
#### 17.5.1.1 PreviousPass : UserExitParameter
|Format|Name|PassNullValue|Value|
|--|--|--|--|
||PreviousPass|false|True|
## 17.6 EdgePassGeometryDetailView : GenericDetailView
|DisplayName|DisplayOrder|IsSecondary|Name|Parameter|View|ViewModel|
|--|--|--|--|--|--|--|
...
## 19.1 NavigateToImportMessage : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
|None|EmptyTile.png|Importmeldungen anzeigen|Importmeldungen anzeigen|NavigateToImportMessage|
### 19.1.1 NavigateToImportMessage : CommandUserExit
|Name|Order|
|--|--|
|NavigateToImportMessage|1|
## 19.2 Images : DetailImageView
|DisplayName|DisplayOrder|Field|IsSecondary|Name|
|--|--|--|--|--|
|Bilder|1|Binaries|false|Images|
## 19.3 WccStagingRecordsResources : DetailListView
|CanMultiselect|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|DisplayName|DisplayOrder|Filter|IsSecondary|IsSortable|Name|RowStyle|
|--|--|--|--|--|--|--|--|--|--|--|--|
|false|false|false|false|false|Bearbeitungs-Importdaten|2||false|true|WccStagingRecordsResources||
# 20 CtDStagingBomLineRecords : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
|--|--|
|NavigateToImportMessage|1|
## 20.2 CtDStagingOrderRecords : DetailRelationListView
|CanMultiselect|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|DetailProperties|DisplayName|DisplayOrder|Entity|Filter|IsSecondary|IsSortable|Name|ParentProperties|RowStyle|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
|--|--|
|NavigateToImportMessage|1|
## 22.2 SapStagingResources : DetailListView
|CanMultiselect|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|DisplayName|DisplayOrder|Filter|IsSecondary|IsSortable|Name|RowStyle|
|--|--|--|--|--|--|--|--|--|--|--|--|
...
|--|--|--|--|--|
|#FFCD5C5E|1|#000000|ImportErrorState|ImportErrorState!="OK"|
# 23 McsStagingRecords : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
|--|--|
|NavigateToImportMessage|1|
## 23.2 McsStagingCustomerOrders : DetailRelationListView
|CanMultiselect|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|DetailProperties|DisplayName|DisplayOrder|Entity|Filter|IsSecondary|IsSortable|Name|ParentProperties|RowStyle|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 34.1 FilterValue : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|FilterValue|1|#000000|FilterValue|true|
## 34.2 EdgeCode : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|EdgeCode|2|#000000|EdgeCode|true|
# 35 WorkerInformationSystem : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 35.1 GoFromProductionOrderToReproduction.3 : LinkContextMenu
...
## 35.9 Binaries : DetailImageView
|DisplayName|DisplayOrder|Field|IsSecondary|Name|
|--|--|--|--|--|
|Zeichnungen|3|Binaries|true|Binaries|
## 35.10 StatusFinished : RowStyleCondition
|Background|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|
|#E1FAE1|1|Green|StatusFinished|ProductionState="Finished"|
## 35.11 StatusInProcessing : RowStyleCondition
|Background|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|
...
|--|--|--|--|--|--|
|#CCD0D8|WorkCenterCode|1|#000000|WorkCenterCode|true|
## 37.3 CustomerEdgeType : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
...
|--|--|--|--|--|
|Zeichnung|1|Picture|false|Binaries|
## 39.2 WorkCenterCode : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|WorkCenterCode|1|#000000|WorkCenterCode|true|
## 39.3 CustomerGlueType : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
...
|--|--|--|--|--|--|
|#CCD0D8|WorkCenterCode|1|#000000|WorkCenterCode|true|
## 40.3 OrientationY : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|OrientationY|2|#000000|OrientationY|true|
## 40.4 OrientationZ : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|OrientationZ|3|#000000|OrientationZ|true|
# 41 PatternEvaluation : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 41.1 PatternView : GenericDetailView
|DisplayName|DisplayOrder|IsSecondary|Name|Parameter|View|ViewModel|
|--|--|--|--|--|--|--|
...
|--|--|--|--|--|
|Zeichnung|1|Picture|false|Binaries|
## 42.2 WorkCenterCode : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|WorkCenterCode|1|#000000|WorkCenterCode|true|
## 42.3 GrooveType : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|GrooveType|2|#000000|GrooveType|true|
## 42.4 GrooveLayer : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|GrooveLayer|3|#000000|GrooveLayer|true|
## 42.5 GrooveDepth : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|GrooveDepth|4|#000000|GrooveDepth|true|
## 42.6 GrooveWidth : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|GrooveWidth|5|#000000|GrooveWidth|true|
## 42.7 GrooveDistance : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|GrooveDistance|6|#000000|GrooveDistance|true|
## 42.8 GrooveShape : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|GrooveShape|7|#000000|GrooveShape|true|
# 43 MakroSurfaces : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 44.1 ConversionType : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
...
## 44.3 OrientationInX : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|OrientationInX|3|#000000|OrientationInX|true|
## 44.4 OrientationInY : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|OrientationInY|4|#000000|OrientationInY|true|
## 44.5 OrientationInZ : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|OrientationInZ|5|#000000|OrientationInZ|true|
# 45 ProcessingDataOrientations : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 46.5 GrooveInProcess2Wrong : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
...
## 48.1 ShowResultEdgeTransition : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
|F4||Ergebnis-Kantenbild anzeigen|Ergebnis-Kantenbild anzeigen|ShowResultEdgeTransition|
### 48.1.1 EdgeTransitionFromWccEdgeInformationToEntityShapeGeometryDialogCommand : CommandUserExit
|Name|Order|
|--|--|
|EdgeTransitionFromWccEdgeInformationToEntityShapeGeometryDialogCommand|1|
#### 48.1.1.1 MinimumAspectRatioForLeftInfoText : UserExitParameter
|Format|Name|PassNullValue|Value|
|--|--|--|--|
||MinimumAspectRatioForLeftInfoText|false|0|
#### 48.1.1.2 ShowResultEdgeTransition : UserExitParameter
|Format|Name|PassNullValue|Value|
|--|--|--|--|
||ShowResultEdgeTransition|false|true|
## 48.2 Binaries : DetailImageView
|DisplayName|DisplayOrder|Field|IsSecondary|Name|
|--|--|--|--|--|
|Zeichnung|1|Picture|false|Binaries|
## 48.3 GeoForm : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|GeoForm|1|#000000|GeoForm|true|
## 48.4 EdgeTransition : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|EdgeTransition|2|#000000|EdgeTransition|true|
## 48.5 DataChange : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|DataChange|3|#000000|DataChange|true|
## 48.6 EdgeIdInput : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|EdgeIdInput|4|#000000|EdgeIdInput|true|
# 49 CtDEdgeInformationToEntityShapes : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 50.1 PartGeometry : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|PartGeometry|1|#000000|PartGeometry|true|
## 50.2 EdgeCode : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|EdgeCode|2|#000000|EdgeCode|true|
# 51 WorkCenterCodeFromCamInformations : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
|--|--|--|--|--|--|
|#CCD0D8|WorkCenterCode|1|#000000|WorkCenterCode|true|
## 53.2 Pass : CellStyleCondition
|Background|Cell|ExecutionOrder|Foreground|Key|Rule|
|--|--|--|--|--|--|
|#CCD0D8|Pass|2|#000000|Pass|true|
# 54 WorkCenterEdgeProfiles : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
# 58 ReorganizationFileSystems : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
# 59 ProductionItemsValidationData : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 59.1 ReleaseNewDataProductionItemsValidation : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
...
### 59.1.1 ReleaseNewDataProductionItemsValidation : CommandUserExit
|Name|Order|
|--|--|
|ReleaseNewDataProductionItemsValidation|10|
## 59.2 DeleteNewDataProductionItemsValidation : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
...
### 59.2.1 DeleteNewDataProductionItemsValidation : CommandUserExit
|Name|Order|
|--|--|
|DeleteNewDataProductionItemsValidation|10|
## 59.3 ProductionOrder : DetailRelationListView
|CanMultiselect|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|DetailProperties|DisplayName|DisplayOrder|Entity|Filter|IsSecondary|IsSortable|Name|ParentProperties|RowStyle|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 60.1 ReleaseNewProductionItemsValidation : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
|F7||Freigabe Nachfertigungsaufträge|Nachfertigungsaufträge freigeben.|ReleaseNewProductionItemsValidation|
### 60.1.1 ReleaseNewProductionItemsValidation : CommandUserExit
|Name|Order|
|--|--|
|ReleaseNewProductionItemsValidation|10|
## 60.2 DeleteNewProductionItemsValidation : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
|None||Lösche Nachfertigungsaufträge|Nachfertigungsaufträge wieder löschen.|DeleteNewProductionItemsValidation|
### 60.2.1 DeleteNewProductionItemsValidation : CommandUserExit
|Name|Order|
|--|--|
...
|--|--|--|--|--|--|
|#FFA8FAC5|ReproductionMode|10|#000000|ReproductionModeDataModification|ReproductionMode="DataModification"|
# 61 ViewItemsProcessingData : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
|--|--|--|--|--|--|--|
|Vorschau|1|false|Vorschau||PartCarrierPreviewView|PartCarrierPreviewViewModel|
# 64 OptimizationRemovement : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
|--|--|
|Module||
## 65.5 Component : Column
|Name|Style|
|--|--|
|Component||
## 65.6 Identifier : Column
|Name|Style|
|--|--|
|Identifier||
# 66 PrintOuts : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
|false|false|false|false|Production|6|PrintOut||Management|false|false|false||true|PrintOuts|||||Small|||10000|
## 66.1 Print : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
|None||Druckdaten|Drucken|Print|
### 66.1.1 ShowWoodPrintPdf : CommandUserExit
|Name|Order|
|--|--|
|ShowWoodPrintPdf|1|
# 67 ScannerCommunication : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
## 68.1 Nachfertigung : GenericDetailView
|DisplayName|DisplayOrder|IsSecondary|Name|Parameter|View|ViewModel|
|--|--|--|--|--|--|--|
||1|false|Nachfertigung||ReproductionDetailView|ReproductionDetailViewModel|
## 68.2 ProductionOrder.Binary : DetailImageView
|DisplayName|DisplayOrder|Field|IsSecondary|Name|
|--|--|--|--|--|
||2||false|ProductionOrder.Binary|
## 68.3 CreateValidationStateDetails : ModulePermission
|Description|Name|
|--|--|
|You are allowed to create ValidationStateDetails and -Sources in GUI|CreateValidationStateDetails|
# 69 PartCarriers : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
|false|false|false|false|Production|15|PartCarrier||Management|false|false|false||true|PartCarriers|||||Small|||10000|
## 69.1 Edit : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
|None||Bearbeiten...|Editieren|Edit|
### 69.1.1 PartCarrierEditCommand : CommandUserExit
|Name|Order|
|--|--|
|PartCarrierEditCommand|1|
## 69.2 Copy : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
|None||Kopieren|Kopieren|Copy|
### 69.2.1 PartCarrierCopyCommand : CommandUserExit
|Name|Order|
|--|--|
|PartCarrierCopyCommand|1|
## 69.3 Paste : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
|None||Einfügen|Einfügen|Paste|
### 69.3.1 PartCarrierPasteCommand : CommandUserExit
|Name|Order|
|--|--|
|PartCarrierPasteCommand|1|
## 69.4 Delete : CommandUserExitContextMenu
|FunctionKey|FunctionKeyIcon|Header|HelpText|Name|
|--|--|--|--|--|
|None||Löschen|Löschen|Delete|
### 69.4.1 PartCarrierDeleteCommand : CommandUserExit
|Name|Order|
|--|--|
|PartCarrierDeleteCommand|1|
## 69.5 Compartments : DetailListView
|CanMultiselect|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|DisplayName|DisplayOrder|Filter|IsSecondary|IsSortable|Name|RowStyle|
|--|--|--|--|--|--|--|--|--|--|--|--|
|false|false|false|false|false||2||false|true|Compartments||
## 69.6 Vorschau : GenericDetailView
|DisplayName|DisplayOrder|IsSecondary|Name|Parameter|View|ViewModel|
|--|--|--|--|--|--|--|
|Vorschau|1|false|Vorschau||PartCarrierPreviewView|PartCarrierPreviewViewModel|
# 70 Restrictions : GenericView
|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|ClientType|Description|Entity|Filter|GroupName|HideFilterPanel|HideMasterPanel|HideUpdate|InitialUserExit|IsSortable|Name|PrintRowReport|PrintTableReport|RowStyle|TileIcon|TileSize|TileView|TileViewModel|UpdateInterval|
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
|false|true|true|true|Production|10030|Restriction||Management|false|false|false||true|Restrictions|||||Small|||0|
## 70.1 RolesRestrictions : DetailListView
|CanMultiselect|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|DisplayName|DisplayOrder|Filter|IsSecondary|IsSortable|Name|RowStyle|
|--|--|--|--|--|--|--|--|--|--|--|--|
|false|false|true|false|true|Gesperrte Rollen|1||false|true|RolesRestrictions||
## 70.2 UserRestrictions : DetailListView
|CanMultiselect|CanUserCopy|CanUserDelete|CanUserEdit|CanUserInsert|DisplayName|DisplayOrder|Filter|IsSecondary|IsSortable|Name|RowStyle|
|--|--|--|--|--|--|--|--|--|--|--|--|
