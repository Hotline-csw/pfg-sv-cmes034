...
[Export("Custom_Select_03mm_Parts", typeof(ControllerMES.Infrastructure.BaseCommon.Contracts.IAutomaticOptimizationRuleSelectionUserExit))]
[Description("Select 3mm Parts ALG")]
[EnabledScript(true)]
public class Custom_Select_03mm_Parts : HomagGroup.FLS.Infrastructure.Common.Customization.UserExitBase, ControllerMES.Infrastructure.BaseCommon.Contracts.IAutomaticOptimizationRuleSelectionUserExit
{
    [Import]
        ...
        using (var unitOfWork = _UnitOfWorkFactory.CreateUnitOfWork())
        {
            ...
            var prodItems = unitOfWork.GetRepository<ProductionItem>().Get(
                    pi => pi.OptimizationTransferState == OptimizationTransferState.NotOptimized &&
                          pi.ProductionOrder.Material == "EG_W5021_03MM" &&
