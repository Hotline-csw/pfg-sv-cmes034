...
//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomFeedbackPreassembly
//
//   Description:    
//
//
...
[Export("CustomFeedbackPreassembly", typeof(HomagGroup.FLS.Infrastructure.Framework.Contracts.ICommandUserExit))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("Manual feedback for preassembly workcenter")]
[EnabledScript(true)]
public class CustomFeedbackPreassembly : UserExitCustomBase, HomagGroup.FLS.Infrastructure.Framework.Contracts.ICommandUserExit//, IPartImportsSatisfiedNotification // TODO MESSAGING
{
...
#pragma warning restore 0649
    ...
    private string _TaskName = "CustomFeedbackPreassembly";
    ...
    public void Execute(object parameter)
    {
        ...
        try
        {
            _Logger = LogHelper.GetLogger(Name, typeof(CustomFeedbackPreassembly));
