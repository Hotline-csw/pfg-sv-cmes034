...
[Export("Custom_Select_16mm_Parts_White", typeof(ControllerMES.Infrastructure.BaseCommon.Contracts.IAutomaticOptimizationRuleSelectionUserExit))]
[Description("Select 16mm White Parts for ALG")]
[EnabledScript(true)]
public class Custom_Select_16mm_Parts_White : HomagGroup.FLS.Infrastructure.Common.Customization.UserExitBase, ControllerMES.Infrastructure.BaseCommon.Contracts.IAutomaticOptimizationRuleSelectionUserExit
{
    [Import]
        ...
        using (var unitOfWork = _UnitOfWorkFactory.CreateUnitOfWork())
        {
            ...
            var prodItems = unitOfWork.GetRepository<ProductionItem>().Get(
                    pi => pi.OptimizationTransferState == OptimizationTransferState.NotOptimized &&
                          pi.ProductionOrder.Material == "DTP_NGR_PRL_16_White" &&
