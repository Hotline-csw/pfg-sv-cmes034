...
//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomFeedbackCutting
//
//   Description:    
//
//
...
[Export("CustomFeedbackCutting", typeof(HomagGroup.FLS.Infrastructure.Framework.Contracts.ICommandUserExit))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("Manual feedback for cutting workcenter")]
[EnabledScript(true)]
public class CustomFeedbackCutting : UserExitCustomBase, HomagGroup.FLS.Infrastructure.Framework.Contracts.ICommandUserExit//, IPartImportsSatisfiedNotification // TODO MESSAGING
{
...
#pragma warning restore 0649
    ...
    private string _TaskName = "CustomFeedbackCutting";
    ...
    public void Execute(object parameter)
    {
        ...
        try
        {
            _Logger = LogHelper.GetLogger(Name, typeof(CustomFeedbackCutting));
