...
[Export("CustomSelectDailyParts", typeof(ControllerMES.Infrastructure.BaseCommon.Contracts.IAutomaticOptimizationRuleSelectionUserExit))]
[Description("Select-UE for Parts with ProductionStartDate >= Today")]
[EnabledScript(true)]
public class CustomSelectDailyParts : HomagGroup.FLS.Infrastructure.Common.Customization.UserExitBase, ControllerMES.Infrastructure.BaseCommon.Contracts.IAutomaticOptimizationRuleSelectionUserExit
{
...
/*            var minQuantityMandatoryItems = 50;
            var minQuantityOptionalItems = 0;
            var maxQuantityOptionalItems = 100;
            var maxQuantityAllParts = 9999;
*/                        
             var maxMaterial = unitOfWork.GetRepository<CustViewAutomaticLotGenerationSelectDailyPartsByCount>()
            ...
            var prodItemsMand = prodItemsRep.GetQueryable(false).Where(
                    pi => pi.OptimizationTransferState == OptimizationTransferState.NotOptimized &&
                          ...
                          pi.CuttingTemplateSequence == null &&
