//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomEPNotOptimizedNotCutted
//
//   Description:    
...
[Export("CustomEPNotOptimizedNotCutted", typeof(ControllerMES.Infrastructure.BaseCommon.Contracts.IFillEPRequirementsUserExit))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("!!! Original UE Horizon for not optimized and not cutted parts")]
[EnabledScript(true)]
public class CustomEPNotOptimizedNotCutted : UserExitCustomBase, ControllerMES.Infrastructure.BaseCommon.Contracts.IFillEPRequirementsUserExit
{
    [Import]
    ...
    private string _PreviewName = "NoOptiNoCut-OG";
    ...
    public void Execute(IJobExecutionContext executionContext)
    {
        ...
        _Logger = LogHelper.GetLogger(executionContext.Area, typeof(CustomEPNotOptimizedNotCutted));
