...
//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomReleaseToAssemblyLineOne
//
//   Description:    
//
//
...
[Export("CustomReleaseToAssemblyLineOne", typeof(HomagGroup.FLS.Infrastructure.Framework.Contracts.ICommandUserExit))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("_Dummy User Exit")]
[EnabledScript(true)]
public class CustomReleaseToAssemblyLineOne : UserExitCustomBase, HomagGroup.FLS.Infrastructure.Framework.Contracts.ICommandUserExit//, IPartImportsSatisfiedNotification // TODO MESSAGING
{
...
#pragma warning restore 0649
    ...
    public void Execute(object parameter)
    {
        ...
        try
        {
            _Logger = LogHelper.GetLogger(Name, typeof(CustomReleaseToAssemblyLineOne));
