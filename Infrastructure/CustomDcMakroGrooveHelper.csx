//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomDcMakroGrooveHelper
//
//   Description:    
//
//
...
[Export(typeof(IDcMakroGrooveHelper))]
[Export(typeof(HomagGroup.FLS.Infrastructure.Common.Customization.IServerCustomization))]
[Export("CustomDcMakroGrooveHelper", typeof(HomagGroup.FLS.Infrastructure.Common.Customization.IServerCustomization))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("Overwrite DcMakroGrooveHelper - shorten the groove string")]
[EnabledScript(true)]
public class CustomDcMakroGrooveHelper : DcMakroGrooveHelper
{
    /// <summary>
    /// Adjusts a GrooveShape for use as a search-value in the data-completion 'GetGrooveMakro'.
    /// </summary>
                                                                    ...
                                                                    ProductionStep productionStep)
    {
        ...
        //      DcShapePassHelper::GetDataCompletionStringFromGrooveShape()             !!
        //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
