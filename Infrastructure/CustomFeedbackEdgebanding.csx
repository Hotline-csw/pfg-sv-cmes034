...
//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomFeedbackEdgebanding
//
//   Description:    
//
//
...
[Export("CustomFeedbackEdgebanding", typeof(HomagGroup.FLS.Infrastructure.Framework.Contracts.ICommandUserExit))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("Manual feedback for edgebanding workcenter")]
[EnabledScript(true)]
public class CustomFeedbackEdgebanding : UserExitCustomBase, HomagGroup.FLS.Infrastructure.Framework.Contracts.ICommandUserExit//, IPartImportsSatisfiedNotification // TODO MESSAGING
{
...
#pragma warning restore 0649
    ...
    private string _TaskName = "CustomFeedbackEdgebanding";
    ...
    public void Execute(object parameter)
    {
        ...
        try
        {
            _Logger = LogHelper.GetLogger(Name, typeof(CustomFeedbackEdgebanding));
                ...
                using (var unitOfWork = _UnitOfWorkFactory.CreateUnitOfWork())
                {
                    foreach (var selectedItem in itemEnumerable.OfType<CustViewMasterManualFeedback>())
                    {
                        ...
                        if (productionItem != null)
                        {
                            ...
                            var ProductionItemsStepsData = ProductionItemsStepsDataRepository.GetFirstOrDefault(po => po.ProductionItemCode == selectedItem.ProductionItemCode && po.ProductionStepCode == "KALWZ14");
