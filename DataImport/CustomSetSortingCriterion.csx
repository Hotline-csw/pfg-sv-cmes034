...
//-----------------------------------------------------------------------------
//   (Class-)Name:   CustomSetSortingCriterion
//
//   Description:    
//
//
...
[Export("CustomSetSortingCriterion", typeof(HomagGroup.FLS.Services.DataImport.Contracts.Contracts.UserExits.IDataImportBeforeSavePackageUserExit))]
[PartCreationPolicy(CreationPolicy.NonShared)]
[Description("04_Divide parttypes in different sorting criterions")]
[EnabledScript(true)]
public class CustomSetSortingCriterion : UserExitCustomBase, HomagGroup.FLS.Services.DataImport.Contracts.Contracts.UserExits.IDataImportBeforeSavePackageUserExit
{
    private Logger _Logger;
    
    private string _TaskName = "CustomSetSortingCriterion";
    ...
    public void Execute(IJobExecutionContext executionContext, TargetItem[] targetItems)
    {
        ...
        try
        {
            _Logger = LogHelper.GetLogger(executionContext.Area, typeof(CustomSetSortingCriterion));
