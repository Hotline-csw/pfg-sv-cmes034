...
//-----------------------------------------------------------------------------
//   (Class-)Name:   SetProductionStepCapacity
//
//   Description:    
//
//
...
public class SetProductionStepCapacity : UserExitCustomBase, HomagGroup.FLS.Services.DataImport.Contracts.Contracts.UserExits.IDataImportBeforeSavePackageUserExit
{
    ...
    private string _TaskName = "SetProductionStepCapacity";
    ...
    public void Execute(IJobExecutionContext executionContext, TargetItem[] targetItems)
    {
		...
		_Logger = LogHelper.GetLogger(executionContext.Area, typeof(SetProductionStepCapacity));
